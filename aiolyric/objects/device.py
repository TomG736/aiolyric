...
class DhwzoneDhwVacationhold(LyricBase):
...
class DhwzoneDhw(LyricBase):

    @property
    def dhwState(self):
        return self.attributes.get("dhwState", None)
    ...
    @property
    def boostDuration(self):
        return self.attributes.get("boostDuration", None)

    @property
    def vacationHold(self):
        return DhwzoneDhwVacationhold(self.attributes.get("vacationHold", {}))

    @property
    def geoBoostEnabled(self):
        return self.attributes.get("geoBoostEnabled", False)
...
class DhwzoneCurrentscheduleperiod(LyricBase):
...
class Dhwzone(LyricBase):
    ...
    @property
    def dhw(self):
        return DhwzoneDhw(self.attributes.get("dhw", {}))

    @property
    def currentSchedulePeriod(self):
        return DhwzoneCurrentscheduleperiod(self.attributes.get("currentSchedulePeriod", {}))
...
class LyricDevice(LyricBaseClient):
    ...
    @property
    def dhwZone(self):
        return Dhwzone(self.attributes.get("dhwZone", {}))
    ...
    @property
    def deviceInternalID(self):
        return self.attributes.get("deviceInternalID", None)

    @property
    def userDefinedDeviceName(self):
        return self.attributes.get("userDefinedDeviceName", None)
    ...
    @property
    def deviceSerialNo(self):
        return self.attributes.get("deviceSerialNo", None)
